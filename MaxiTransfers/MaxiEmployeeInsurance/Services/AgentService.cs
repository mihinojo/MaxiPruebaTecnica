...
namespace MaxiEmployeeInsurance.Services
{
        ...
        where TResponse : class
    {
        ...
        public void Get(AgentParameters<TEntity> param)
        ...
        public void Post(AgentParameters<TEntity> param)
       ...
       { param.Metodo = Method.Post; await RequestAsync(param); return resp; }
        ...
        public void Put(AgentParameters<TEntity> param)
        ...
        public void Delete(AgentParameters<TEntity> param)
        ...
        public void Peticion(AgentParameters<TEntity> param)
            => RequestAsync(param).Wait();

        public async Task<TResponse> PeticionAsync(AgentParameters<TEntity> param)
